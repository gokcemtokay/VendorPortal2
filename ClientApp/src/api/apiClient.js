...
export const userApi = {
    getAll: () => apiClient.get('/UserApi/GetAll'),
    getById: (id) => apiClient.get(`/UserApi/Get/${id}`),
    create: (data) => apiClient.post('/UserApi/Create', data),
    update: (data) => apiClient.put('/UserApi/Update', data),
    delete: (id) => apiClient.delete(`/UserApi/Delete/${id}`),
    toggleStatus: (id) => apiClient.post(`/UserApi/ToggleStatus/${id}`),
    changePassword: (data) => apiClient.post('/UserApi/ChangePassword', data),
    getByRole: (role) => apiClient.get(`/UserApi/GetByRole/${role}`),
    getByFirma: (firmaId) => apiClient.get(`/UserApi/GetByFirma/${firmaId}`)
};
...
export const firmaApi = {
    ...
    reddet: (id, redNedeni) => apiClient.post(`/FirmaApi/Reddet/${id}`, { redNedeni }),
...
export const siparisApi = {
    ...
    updateKalemDurumu: (data) => apiClient.post('/SiparisApi/UpdateKalemDurumu', data),
    iptalEt: (id, iptalNedeni) => apiClient.post(`/SiparisApi/IptalEt/${id}`, { iptalNedeni })
};

// User Management API (Gelişmiş Kullanıcı Yönetimi)
